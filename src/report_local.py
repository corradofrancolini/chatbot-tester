"""
Report Generator - Generazione report locali HTML e CSV

Gestisce:
- Report HTML navigabile con statistiche
- Export CSV per analisi
- Summary JSON con metadata run
...
class TestResultLocal:
    """Risultato test per report locale"""
    test_id: str
    date: str
    mode: str
    question: str
...
class ReportGenerator:
    """
    Generatore report locali.
    
    Features:
    - Report HTML interattivo con filtri
    - Export CSV compatibile Excel
    - Summary JSON per automazione
    ...
    def __init__(self, output_dir: Path, project_name: str = ""):
        ...
        Args:
            output_dir: Directory per output (es. reports/project/run_001)
    ...
    def generate(self) -> Dict[str, Path]:
        ...
        Returns:
            Dict con paths: {html, csv, summary}
        """
        ...
        with open(path, 'w', newline='', encoding='utf-8') as f:
            ...
            for r in self.results:
                writer.writerow({
                    ...
                    'notes': r.notes,
                    'conversation': r.conversation[:1000],  # Tronca
    ...
    def _generate_html(self) -> Path:
        ...
        for r in self.results:
            ...
            # Formatta conversazione (escape HTML)
...
<body>
    ...
    def get_screenshot_path(self, test_id: str) -> Path:
        """Ritorna path per salvare screenshot di un test"""
        return self.screenshots_dir / f"{test_id}.png"


def aggregate_reports(reports_dir: Path, project_name: str) -> Dict[str, Any]:
    """
    Aggrega statistiche da tutte le run di un progetto.
    
    Args:
        reports_dir: Directory reports (es. reports/my-project/)
        project_name: Nome progetto
    ...
    if not runs:
        return {'error': 'Nessuna run trovata'}
    ...
    return {
        ...
        'trend': [
            ...
            for r in runs[-10:]  # Ultime 10 run
        ]
    }
